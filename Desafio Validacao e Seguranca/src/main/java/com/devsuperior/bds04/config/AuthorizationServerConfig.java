...
public class AuthorizationServerConfig {
	...
	@Bean
	@Order(2)
	public SecurityFilterChain asSecurityFilterChain(HttpSecurity http, CustomPasswordAuthenticationProvider customPasswordAuthenticationProvider) throws Exception {
