...
public class MovieGenreDTO {
	...
	@Schema(description = "Database generated movie ID") // descrição para ser exibida no swagger
	private Long id;
	
	@NotBlank(message = "Required field")
	@Size(min = 5, max = 80, message = "Title must be between 5 and 80 characters")
	@Schema(description = "Movie title") // descrição para ser exibida no swagger
